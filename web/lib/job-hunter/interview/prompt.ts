...
2) "diagrams": several minimal, ACCURATE technical diagrams as self-contained SVG. Be THOROUGH about COVERAGE: produce one diagram for EACH major sub-concept the question covers, so together they walk through the whole topic — do NOT skip any sub-concept (e.g. for a Kafka question that means topic/partition/offset, producer & partitioning, consumer group assignment, AND rebalance). Produce 4–6 diagrams. Each is a comparison table, boxes-and-arrows, or a small architecture/flow.
